...
public class Main {
    public static void main(String[] args) {
        ...
        /*List<Souvenir> souvenirs = new ArrayList<>(List.of(
                new NovaPostCup("NPCup1", new NovaPost("UK"), new Date("02/11/2022"), 200.0),
                new NovaPostCup("NPCup2", new NovaPost("USA"), new Date("25/09/2021"), 150.0),
                new UkrPostCup("UPCup1", new UkrPost("USA"), new Date("16/10/2022"), 150.0),
                new PrivatBankKeychain("PBKeychain1", new PrivatBank("UA"), new Date("22/05/2020"), 50.0),
                new KyivCityPostcard("KCPostCard1", new KyivCity("UA"), new Date("07/02/2019"), 25.0)
        ));*/
